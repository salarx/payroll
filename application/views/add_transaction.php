            ...
            <div class="panel-body">
                <div class="form">
                  <?php if($this->session->userdata('category') == 1) { ?>
                    <form class="form-validate form-horizontal" id="feedback_form" method="post" action="<?php echo base_url(); ?>transaction_admin/add_transaction_commit.html">
                        <div class="form-group">
                            <label for="amount" class="control-label col-lg-2">Amount</label>
                            <div class="col-lg-10">
                                <input name="id" type="hidden" value="<?php echo $dep_id; ?>" />
                  ...
                  <?php } if($this->session->userdata('category') == 2) { ?>
                    <form class="form-validate form-horizontal" id="feedback_form" method="post" action="<?php echo base_url(); ?>transaction_dep/add_transaction_commit.html">
                        <div class="form-group">
