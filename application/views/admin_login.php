...
<br><br>
                    <div class="input-group ">
                        ...
                        <label class="col-lg-5" style="font-size:18px" align="right"><b>Admin ID</b></label>
                      ...
                      <br>
                          ...
                          <label class="col-lg-5" style="font-size:18px" align="right"><b>Password</b></label>
